...
export type Rules<P extends Record<string, any> = Properties> = Style<P> & Grouping<P>;

export type KeyframeRules = { [time in "from" | "to"]?: Properties } | { [time: string]: Properties };
